    ...
    <div class="max-w-5xl mx-auto px-4 py-10">
        <div class="bg-gray-900/80 backdrop-blur-md rounded-2xl shadow-xl p-8">
            <h1 class="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-blue-500 mb-8">
                <i class="fas fa-tv mr-2"></i> Nova serija
            </h1>
            ...
            <form method="POST" action="{{ route('series.store') }}" enctype="multipart/form-data" id="series-form">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="4" 
                                  class="w-full bg-gray-800 text-white rounded-lg p-3 focus:ring-2 focus:ring-blue-500 outline-none"></textarea>
                    </div>
                ...
                {{-- Sezone --}}
                <div class="mt-10" x-data="{ seasons: [] }">
                ...
                <div class="mt-8 flex gap-4">
                    <button type="submit" 
                        ...
                        <i class="fas fa-save mr-2"></i> Sačuvaj seriju
                    </button>
